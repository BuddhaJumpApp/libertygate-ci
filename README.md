...
Build workflows for the **libertygate** Flutter VPN app. Same pipeline as BuddhaJump's,
...
Checkout:
- `PRIVATE_REPO` — `BuddhaJumpApp/libertygate`
...
- `APPLE_PROVISIONING_BASE64` — provisioning profiles for `com.fjolsky.libertygate` and `com.fjolsky.libertygate.service`
